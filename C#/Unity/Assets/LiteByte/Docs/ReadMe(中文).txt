...
------------------ 字符串类型 1种(4种编码) ------------------
类型:UTF8		字符长度:1~4字节	总字节长度:(1~5)字节 + (0 ~ int.MaxValue - 1) 字节
类型:Unicode	    字符长度:2字节	总字节长度:(1~5)字节 + (0 ~ int.MaxValue - 1) x 2 字节
类型:ASCII		字符长度:1字节	总字节长度:(1~5)字节 + (0 ~ int.MaxValue - 1) 字节
类型:VarUnicode		字符长度:1字节	总字节长度:(1~5)字节 + (0 ~ int.MaxValue - 1) 字节
